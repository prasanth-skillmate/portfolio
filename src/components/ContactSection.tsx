...
import { Mail, Linkedin, Twitter, Send, Shield, Phone, GraduationCap, ExternalLink, MessageCircle, Loader2 } from 'lucide-react';
...
const ContactSection = () => {
    ...
    try {
      ...
      toast({
        ...
        description: error instanceof Error 
          ? error.message 
          : "There was an error sending your message. Please try again or contact me directly at cybersecure8@gmail.com",
        variant: "destructive",
      });
    } finally {
  ...
  const socialLinks = [
    { icon: Linkedin, href: 'https://www.linkedin.com/in/sathsish90/', label: 'LinkedIn', external: true },
    { icon: Twitter, href: 'https://x.com/sathsish90', label: 'Twitter/X', external: true },
    { icon: Mail, href: 'mailto:cybersecure8@gmail.com', label: 'Email' },
  ];

  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'cybersecure8@gmail.com', href: 'mailto:cybersecure8@gmail.com' },
    { icon: Phone, label: 'Phone', value: '+91 98409 69548', href: 'tel:+919840969548' },
    { icon: GraduationCap, label: 'Mentorship', value: 'skillmate.ai/sathish', href: 'https://skillmate.ai/sathish', external: true },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm sm:text-base md:text-lg">
              Ready to secure your digital assets? Let's discuss how I can help protect your organization.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="order-2 lg:order-1">
              ...
              >
                <Button variant="cyber-outline" size="lg" className="w-full group bg-green-500/10 border-green-500/30 hover:bg-green-500/20 hover:border-green-500/50">
            ...
            <div className="order-1 lg:order-2 space-y-5 md:space-y-6">
              ...
              <div className="p-4 md:p-6 bg-card border border-primary/20 rounded-xl">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-4 md:mb-6">
                  ...
                  <div className="text-center sm:text-left">
                    <h3 className="font-display font-semibold text-base md:text-lg">Sathish Kumar Balakrishnan</h3>
                    <p className="text-muted-foreground text-xs md:text-sm">Cybersecurity Specialist</p>
                  </div>
                </div>
                  ...
                  {contactInfo.map((info, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
                        ...
                        <span className="text-foreground font-mono group-hover:text-primary transition-colors break-all">{info.value}</span>
                        {info.external && <ExternalLink className="w-3 h-3 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" />}
                      </div>
                    </a>
                  ))}
                </div>
              ...
              {/* Social Links */}
              <div className="p-4 md:p-6 bg-card border border-primary/20 rounded-xl">
                <h4 className="font-display font-semibold mb-3 md:mb-4 text-sm md:text-base">Connect on Social</h4>
